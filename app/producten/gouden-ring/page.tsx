...
export default function GoudenRingPage() {
    ...
    <main className="min-h-screen bg-[#f8f6f2] px-6 py-10 text-stone-950">
      ...
      <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="text-5xl font-semibold">Gouden trouwring</h1>

          <p className="mt-6 text-lg leading-8 text-stone-600">
            Luxe gouden trouwring met een tijdloze uitstraling. Perfect voor
            koppels die kiezen voor warmte, klasse en persoonlijke gravering.
          </p>

          <p className="mt-8 text-4xl font-semibold">€999</p>
          ...
          <button
            onClick={addToCart}
            className="mt-8 rounded-full bg-[#C6A85B] px-8 py-4 text-lg font-medium text-black transition hover:opacity-90"
          >
